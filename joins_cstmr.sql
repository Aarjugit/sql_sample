...
LOCK TABLES `cstmr` WRITE;
/*!40000 ALTER TABLE `cstmr` DISABLE KEYS */;
INSERT INTO `cstmr` VALUES (1,'Fred','Fish'),(2,'Larry','Lobster'),(3,'Bubble','Bass'),(4,'Poppy','Puff');
/*!40000 ALTER TABLE `cstmr` ENABLE KEYS */;
UNLOCK TABLES;
